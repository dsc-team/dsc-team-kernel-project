...
#define LOGGER_LOG_OOB		"log_oob"	/* oob */
#endif


#define LOGGER_ENTRY_MAX_LEN		(4*1024) //DO NOT change
...
#define LOGGER_SET_GLOBAL_PRINTK2MAINLOG_LEVEL _IO(__LOGGERIO, 5) /* change global_printk2mainlog_level */
#endif
#ifdef __KERNEL__
enum {
