...
// Jagan+
#define QISDA_HANDSET_LOOKBACK                          0xFB    /* Mic1 -> Receiver */
#define QISDA_HEADSET_LOOKBACK                          0xFC    /* Mic2 -> headset */
#define QISDA_LOUDSPEAKER_LOOKBACK                      0xFD    /* Mic1 -> Loudspeaker */
